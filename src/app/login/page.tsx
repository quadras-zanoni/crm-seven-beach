      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{ background: 'linear-gradient(135deg,#E76F51 0%,#2A9D8F 50%,#52B788 100%)' }}
          >
          ...
          <p className="text-[#8ab5b1] text-sm mt-1.5">Arena de Beach Sports</p>
        </div>
        ...
        >
          {!showReset ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="text-xs text-[#8ab5b1] hover:text-[#52B788] transition-colors tracking-wide"
                >
                  Esqueci minha senha
                </button>
              </div>
            ...
            <form onSubmit={handleReset} className="space-y-4">
              <p className="text-sm text-[#8ab5b1] mb-3 leading-relaxed">
              ...
              <button
                ...
                className="text-xs text-[#8ab5b1] hover:text-[#f0faf9] transition-colors w-full text-center tracking-wide"
              >
                ← Voltar ao login
              </button>
            </form>
        ...
        <p className="text-center text-sm text-[#8ab5b1] mt-6 tracking-wide">
          Não tem conta?{' '}
