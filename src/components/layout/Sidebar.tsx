    ...
    >
      ...
      {badge != null && badge > 0 && (
        <span
          ...
          style={{ background: 'linear-gradient(90deg,#E76F51,#2A9D8F)' }}
        >
          {badge > 99 ? '99+' : badge}
        </span>
      )}
  ...
  return (
    <>
      ...
      <div className="px-4 mb-7">
        ...
        <div
          className="mt-5 h-px"
          style={{ background: 'linear-gradient(90deg,#E76F51,#2A9D8F,transparent)' }}
        />
      </div>
    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading font-bold text-xs tracking-widest gradient-text">SEVEN BEACH</span>
        </div>
        <button
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <aside
            ...
            style={{ background: '#0d1c1a', borderRight: '1px solid rgba(255,255,255,0.06)' }}
          >
